...
//     const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/notes/search`);
//     const data = await response.json();
//     const allQueries = data.map(item => item.query)
//     const paths = allQueries.map(query=>({params: {query: query}}))
//     return {
//         paths,
//         fallback: false,
//     }
...
//     const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/notes/search/${params.query}`);
//     const data = await response.json();
